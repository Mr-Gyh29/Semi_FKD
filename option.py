...
def args_parser():
    ...
    parser.add_argument('--sample_method', default='Dirichlet',
                        help='Dirichlet, JSTSP')
    parser.add_argument('--loss_F', default='MSE',
                        help='CEKD, MSE')
    ...
    parser.add_argument('--lambda2', type=float, default=0.05, help='hyper-parameter for taylor expansion')

    parser.add_argument('--is_allocation', default=True,
                        help='whether to use resource allocation')
    parser.add_argument('--method_Teacher', default='Cosine',
    ...
    parser.add_argument('--tol', type=float, default=1e-3,
                        help='tolerance for convergence in CVX')
    parser.add_argument('--duration_round', type=float, default=1000000, help='duration of one round')
    ...
    parser.add_argument('--alg', default='FedKD',
                        help='FedAvg, FedProx, Moon, FedMD, Fedproto, FedKD')
    ...
    parser.add_argument('--total_bandwidth', type=float, default=1e30, help='total bandwidth of the edge server')
